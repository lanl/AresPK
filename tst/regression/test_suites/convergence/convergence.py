...
method_cfgs = [
    {"integrator": "rk2", "recon": "plm", "riemann": "hlle"},
    {"integrator": "rk2", "recon": "plm", "riemann": "hllc"},
    {"integrator": "vl2", "recon": "plm", "riemann": "hlle"},
    {"integrator": "vl2", "recon": "plm", "riemann": "hllc"},
]

all_cfgs = list(itertools.product(method_cfgs, res_list))
...
class TestCase(utils.test_case.TestCaseAbs):
    def Prepare(self, parameters, step):
        ...
        method_cfg, res = all_cfgs[step - 1]  # step counting starts at 1
        ...
        parameters.driver_cmd_line_args = [
            ...
            % (3 if (method_cfg["recon"] == "ppm") else 2),
            "parthenon/time/integrator=%s" % method_cfg["integrator"],
            "hydro/reconstruction=%s" % method_cfg["recon"],
            "hydro/riemann=%s" % method_cfg["riemann"],
        ]
